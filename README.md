<h1>🖥️ System Monitor CLI Tool</h1>
...
<h2>✨ Features</h2>
<ul>
  <li>🧠 Display current <strong>CPU usage</strong> percentage</li>
  <li>🧬 Show <strong>memory usage</strong> percentage</li>
  <li>💾 Check <strong>disk usage</strong> of the root directory</li>
  <li>📋 List all running processes with their <strong>PID, CPU, and memory</strong> usage</li>
  <li>🔎 Find the <strong>PID</strong> of a process by its name</li>
</ul>
